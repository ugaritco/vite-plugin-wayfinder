...
Vite plugin for [Wayfinder](https://github.com/ugarit/wayfinder).
...
export default defineConfig({
    plugins: [
        wayfinder({
            ...
            command: "herd php scribe wayfinder:generate",
            routes: false,
            actions: true,
            formVariants: false,
...
Please review [our security policy](https://github.com/ugarit/vite-plugin-wayfinder/security/policy) on how to report security vulnerabilities.
